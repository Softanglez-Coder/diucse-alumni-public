            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
              ...
              <form [formGroup]="contactForm" (ngSubmit)="onSubmit()" class="space-y-6">
                ...
                <button
                  ...
                  class="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-200 disabled:opacity-50"
                >
                  @if (isSubmitting) {
            ...
            <div class="space-y-8">
              ...
              <div class="space-y-6">
                <div class="flex items-start">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-gray-600">Dhaka International University<br>66 Green Road, Dhanmondi<br>Dhaka-1205, Bangladesh</p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-gray-600">alumni&#64;diucse.org<br>support&#64;diucse-alumni.org</p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-gray-600">+880 2 9123456<br>+880 1700 000000</p>
                  </div>
                </div>
              ...
              <div class="pt-8 border-t border-gray-200">
                ...
                <div class="flex space-x-4">
                  <a href="#" class="w-10 h-10 bg-primary text-white rounded-lg flex items-center justify-center hover:bg-primary transition-colors">
                  ...
                  <a href="#" class="w-10 h-10 bg-blue-500 text-white rounded-lg flex items-center justify-center hover:bg-primary transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

...
import { BannerCarousel, ContactSection, LatestBlogs, CurrentCommittee } from '../../shared';
...
@Component({
  ...
  imports: [BannerCarousel, ContactSection, MembersList, LatestBlogs, CurrentCommittee],
})
export class Home {

...
export default function GalleryPage() {
  const [sortedGallery, setSortedGallery] = useState<GalleryItem[]>(gallery); // Specify type for the gallery
  const [selectedImage, setSelectedImage] = useState<GalleryItem | null>(null); // Ensure the type can be null
